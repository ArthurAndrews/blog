---
title: A statistical model for MLB player aging
author: Arthur Andrews
date: 9/1/2024
format: html
image: /images/other/player_aging3.png
editor: source
...
These are my goals for this initial work on this blog.  I have a few other ideas for how to use this model to do some interesting things, and those will be the subjects of future posts.
...
This is a hobby project.  I am not interested in doing exhaustive work in any one area.  I will do the sort of lighter analysis that is fun to me.  I will refer elegant models, statistical models (not black box machine learning), and nice graphics.
